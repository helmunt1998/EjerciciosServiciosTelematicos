...
<body>
    <?php //Inicio de un script PHP
        ...
        $null_val = null; //variable con valor nulo, si una variable no tiene algo asignado, es null.
       ...
       // min(/*argumento1, argumento2, ...*/); //devuelve el mínimo de los argumentos de entrada
       // max(/*argumento1, argumento2, ...*/); //devuelve el mínimo de los argumentos de entrada
